...
public class EdcListview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edc_listview);

        mylistview=(ListView)findViewById(R.id.list3);

        searchView = (SearchView) findViewById(R.id.searchbar);

        final ArrayAdapter<String> myadapter = new ArrayAdapter<String>(this,R.layout.activity_edc_update,R.id.textView22,myarraylist);

        database1= FirebaseDatabase.getInstance();
        datarefer= database1.getReference("EDC News");
