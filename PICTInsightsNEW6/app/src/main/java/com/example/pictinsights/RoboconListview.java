...
public class RoboconListview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_robocon_listview);

        mylistview=(ListView)findViewById(R.id.list3);

        searchView = (SearchView) findViewById(R.id.searchbar);

        final ArrayAdapter<String> myadapter = new ArrayAdapter<String>(this,R.layout.activity_robocon_update,R.id.textView191,myarraylist);
